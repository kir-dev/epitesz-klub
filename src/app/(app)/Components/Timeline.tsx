                ...
                <div className="relative">
                    ...
                    {items.map((item, index) => (
                        <div
                            ...
                            className={`timeline-item relative mb-16 transition-all duration-500 ease-in-out ${
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {isMedia("picture" in item ? item.picture : null) && (
                                        <div className="relative aspect-video bg-[#27272A] overflow-hidden">
                                            <Image
                                                src={("picture" in item && isMedia(item.picture) && item.picture.url) ? item.picture.url : "/placeholder.svg"}
                                                alt={`Image for year ${
